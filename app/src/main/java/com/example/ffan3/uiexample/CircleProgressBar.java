...
public class CircleProgressBar extends View {
    ...
    /**默认刻度角度*/
    private final int TICK_BLOCK_DEFAULT_ANGLE = 1;

    private final int TICK_UNSELECTED_SIZE = 40;
    /**默认刻度长度*/
    private final float NORMAL_TICK_DEFAULT_SIZE = 70;
    /**默认当前刻度长度*/
    private final float CURRENT_TICK_DEFAULT_SIZE = 55;
    /**默认渐变起始颜色*/
    ...
    //未选中刻度长度
    private float mUnSelectedTickSize;
    /**正常刻度的长度*/
    ...
    private void init(TypedArray typedArray){
        ...
        mUnSelectedTickSize = typedArray.getDimension(R.styleable.CustomProgressBar_unselected_tick_size,TICK_UNSELECTED_SIZE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalTickCount; i++) {
            if(i == currentBlockIndex -1){
                ...
                //未选中的刻度
                mPaint.setStrokeWidth(mUnSelectedTickSize);
